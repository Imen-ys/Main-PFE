        ...
        <>
            <form action="{% url 'formulaire_client' %}" method="post">
                ...
                <div style={{ display: "block" }}>
                    ...
                    <Style>
                    <Input name="Raison sociale :" type="text" id="Raison_sociale" value="Raison_sociale"/>
                        <Input name="Sigle :" type="text" id="Sigle" value="Sigle"/>
                    </Style>
                    <Input name="Code TVA :" type="text" id="Code_TVA"  value="Code_TVA"/>

                    <Style>
                        <Input name="Nature du compte :" type="text" id="Nature_du_compte"  value="Nature_du_compte"/>
                        <Input name="NIF :" type="text" id="NIF"  value="NIF"/>
                        <Input name="NIS :" type="text" id="NIS" value="NIS"/>
                    </Style>

                    <Style>
                        <Input name="Registre de commerce :" type="text" id="Registre_de_commerce"  value="Registre_de_commerce"/>
                    ...
                    <Style>
                        ...
                        <Select name="Catégorie de compte :" v1="A" v2="I" choix1="Client" choix2="Supplier" id="Catégorie_de_compte" value="Catégorie_de_compte" />
                        <button type="submit" className="Btn"onClick={save}>Envoyer</button>
                    </div>
            </form>
        </>
    );
